...
document
  .getElementById("delete-propietario")
  .addEventListener("submit", async (evento) => {
    ...
    const form = document.getElementById("delete-propietario");
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/propietarios/${id}`,
        {
      ...
      if (response.ok) {
        ...
        console.log("Propietario elimina exitosamente:" + result);
        alert("Propietario eliminado con exito: " + result);
      } else {
