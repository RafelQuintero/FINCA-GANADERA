...
document
  .getElementById("propietario-form")
  .addEventListener("submit", async (e) => {
    ...
    const form = document.getElementById("propietario-form");
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert("Propietario registrada con éxito");
        ...
        alert("Error al registrar Propietario: " + errorText);
      }
