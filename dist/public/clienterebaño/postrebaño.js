...
document.getElementById("rebaño-form").addEventListener("submit", async (e) => {
  ...
  const form = document.getElementById("rebaño-form");
  ...
  try {
    ...
    if (response.ok) {
      ...
      alert("Error al registrar Animal: " + errorText);
    }
