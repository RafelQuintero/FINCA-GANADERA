//*Se captura el  el formuario por medio del id para hacer evento sumit por medio de listerner
// * de formulario

document.getElementById("finca-form").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      alert("Error al registrar finca: " + errorText);
    }
